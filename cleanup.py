...
if __name__ == '__main__':
    ...
    for language in languages:
        ...
        cleanup(["/cs/usr/bareluz/gabi_labs/nematus_clean/debias_files/en-"+language +"/debias",
                 "/cs/usr/bareluz/gabi_labs/nematus_clean/debias_files/en-"+language +"/evaluate",
                 "/cs/usr/bareluz/gabi_labs/nematus_clean/debias_files/en-"+language +"/output",],
                files_to_ignore)
